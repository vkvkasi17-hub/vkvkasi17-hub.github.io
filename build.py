...
portfolio_data = {
    "name": "KASI MEKA",
    "profile_pic": "IK0C0204.jpeg",
    "job_title": "Python Developer & Data Engineer",
    "headline": "Specializing in Data Engineering, Analytics & Cloud Platforms",
    
    "about_me": """
        Hi, I'm Kasi Meka — a Python Developer and Backend Engineer passionate about building scalable applications, automation systems, and data-driven solutions. I specialize in developing robust backend services, REST APIs, and cloud-based data pipelines using modern technologies.
        <br><br>
        ...
        <br><br>
        With 4+ years of experience in software development, I have worked on enterprise applications involving Python, cloud platforms, microservices architecture, and AI-driven automation. I enjoy solving complex technical problems, improving system performance, and building reliable software that delivers real business value.
    ...
    "projects": [
        {
            ...
            "description": "Designed and developed interactive visual dashboards in Tableau to analyze One Day International (ODI) cricket match data from 2000 to 2020, uncovering key trends in player performance and match outcomes.",
            "color": "#ffeb3b" # Neon Yellow
        },
        {
            "title": "LA Crime Pattern Analysis",
            "tech": "Data Visualization, Data Analytics",
            "description": "Created comprehensive visual dashboards to analyze crime patterns and geographical trends across Los Angeles from 2020 to 2025, providing actionable insights into public safety metrics.",
    ...
    "publications": [
        {
            ...
            "year": "2025",
            "authors": "Lund, B., Orhan, Z., Mannuru, N. R., Bevara, R. V. K., Porter, B., Vinaih, M. K., & Bhaskara, P. (2025). Standards, frameworks, and legislation for artificial intelligence (AI) transparency. AI and Ethics, 1-17."
        }
    ],
...
<body>
    ...
    <footer>
        <p>Connect with me:</p>
        <p>Email: {portfolio_data['contact']['email']} | Phone: {portfolio_data['contact']['phone']} | GitHub: <a href="https://github.com/{portfolio_data['contact']['github']}" target="_blank">{portfolio_data['contact']['github']}</a></p>
    </footer>
